...
# biting_repository.delete(biting_3.id)
biting_3.human = human_1
biting_repository.update(biting_3)

bitings = biting_repository.select_all()
for biting in bitings:
    print(biting.__dict__)

# biting = biting_repository.select(biting_3.id)
# print(biting.__dict__)

humans = zombie_repository.get_biten_humans(zombie_2)
for human in  humans:
